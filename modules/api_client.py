...
class ApiClient:
    ...
    def _prepare_messages(self, system_prompt: str, messages: List[Dict[str, str]]) -> List[Dict[str, str]]:
        """准备消息列表
    ...
    def _prepare_payload(self, system_prompt: str, messages: List[Dict[str, str]], 
    ...
    def send_request(self, system_prompt: str, messages: List[Dict[str, str]], 
                    functions: Optional[List[Dict[str, Any]]] = None) -> Dict[str, Any]:
        """发送请求并获取完整响应
    ...
    async def send_request_stream(self, system_prompt: str, messages: List[Dict[str, str]], 
        ...
        Args:
            ...
            messages (List[Dict[str, str]]): 消息历史
            functions (Optional[List[Dict[str, Any]]], optional): 函数定义列表
            callback (callable, optional): 回调函数，用于处理每个响应块
